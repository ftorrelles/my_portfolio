                ...
                <div className="Portfolio_content">
                    ...
                    <div className="Portfolio__Project">
                        ...
                        <div className="Portfolio__Project-Description">
                            ...
                            >
                                <p>
                                    Pagina web estatica, empresa investigación
                                    de mercado. <br />
                                    <br />
                                    construido en React.js <br />
                                    <br />
                    ...
                    <div className="Portfolio__Project">
                        ...
                        <div className="Portfolio__Project-Description">
                            ...
                            >
                                <p>
                                    Construcción del frontend de una tienda
                                    virtual (eCommerce) de artículos de
                                    tecnología y del hogar. <br />
                                    <br />
                                    construido en React.js y en node.js <br />
                                    <br />
                                    haz click acá para verlo
                    ...
                    <div className="Portfolio__Project">
                        ...
                        <div className="Portfolio__Project-Description">
                            ...
                            >
                                <p>
                                    Creación de app para los fanáticos de
                                    Pokemon, en la cual pueden buscar
                                    información de sus pokémons favoritos.{" "}
                                    <br />
                                    <br />
                                    construido en React.js <br />
                                    <br />
                    ...
                    <div className="Portfolio__Project">
                        ...
                        <div className="Portfolio__Project-Description">
                            ...
                            >
                                <p>
                                    app para mostrar diferentes tipos de
                                    cócteles. <br />
                                    <br />
                                    construido en React.js <br />
                                    <br />
